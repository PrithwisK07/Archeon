...
export function EditorPanel({ onClose }: { onClose: () => void }) {
  ...
  if (isCompiling) {
    return (
      <div className="absolute top-0 right-0 w-[700px] h-full bg-[#0A0A0A] border-l border-white/10 flex flex-col items-center justify-center z-50">
  ...
  if (compileError) {
    return (
      <div className="absolute top-0 right-0 w-[700px] h-full bg-[#0A0A0A] border-l border-white/10 p-6 z-50 flex flex-col">
  ...
  return (
    <div className="absolute top-0 right-0 w-[800px] h-full bg-[#0A0A0A] border-l border-white/10 flex z-50 shadow-2xl">
          ...
          <div className="flex gap-3 items-center">
            ...
            {!isReadOnly && (
              <button 
                ...
                className="px-3 py-1.5 bg-indigo-500/20 text-indigo-400 border border-indigo-500/30 rounded text-xs font-mono hover:bg-indigo-500/30 transition-colors"
